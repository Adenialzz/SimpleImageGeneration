...
class DiT(nn.Module):
    ...
    def __init__(
        ...
        # self.x_embedder = PatchEmbed(input_size, patch_size, in_channels, hidden_size, bias=True)  # TypeError: PatchEmbed.__init__() got an unexpected keyword argument 'bias'
